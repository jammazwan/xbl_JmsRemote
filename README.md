...
Functionality: **_JMS messaging to a remote running JMS server_**
...
Git clone the xbl_JmsRemote project into your workspace:

_from your bash shell:_

```bash
cd yourworkspacedirectory
git clone https://github.com/jammazwan/xbl_JmsRemote.git
cd xbl_JmsRemote
mvn install -DskipTests

```

You man now import xbl_JmsRemote into your IDE.
...
_run XblTest, also see NOTES.md_
